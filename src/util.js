...
function parseMailBody(text) {
  ...
  var matches = [
    ...text.matchAll(/(?:[账帐][户号戶](?:名|名称)?|用[户戶]名|使用[者著]名稱)[是為]?[：:]?"(?:User:)?(.+?)"/g),
    ...text.matchAll(/(?:[账帐][户号戶](?:名|名称)?|用[户戶]名|使用[者著]名稱)[是為]?[：:]?“(?:User:)?(.+?)”/g),
    ...text.matchAll(/(?:[账帐][户号戶](?:名|名称)?|用[户戶]名|使用[者著]名稱)[是為]?[：:]?【(?:User:)?(.+?)】/g),
    ...text.matchAll(/(?:[账帐][户号戶](?:名|名称)?|用[户戶]名|使用[者著]名稱)[是為]?[：:]?\s*[\[［]\s*(?:User:)?(.+?)\s*[\]］]/g),
    ...text.matchAll(/(?:[账帐][户号戶](?:名|名称)?|用[户戶]名|使用[者著]名稱)(?:[是為为：:]|[是為为][：:])\n?(?:User:)?([^\[\]［］【】"“”：:，、。；,.\n]+)[，、。；,.\n]/g),
